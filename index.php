...
<div id="wrap">
       ...
       <a href="#4" class="nav reg navbar-btn btn btn-default btn-plus disabled" > REGISTER </a>
    ...
    <div id="1" class="section seventy">
        ...
        <div class="grid">
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/bbqweb.png)"></div>
					<h3>Kickoff BBQ</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 19, 2018</p>
                    <p>Greek Lawn</p>
                    <div class="desc">
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/flowercrownweb.png)"></div>
					<h3>DIY Flower Crowns</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 19, 2018</p>
                    <p>Greek Lawn</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/StarWars_Web.png)"></div>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/sf_thumb.png)"></div>
					<h3>Springfest</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 19, 2018</p>
...
//            endforeach;
    ...
    <div id="2" class="section eighty">
        ...
        <div class="grid">
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/Pizza_Web.png)"></div>
					<h3>Pizza Palooza!</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 20, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/puppyfestweb.png)"></div>
					<h3>PuppyFest</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 20, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/bobrossweb.png)"></div>
					<h3>An Evening of Bob Ross</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 20, 2018</p>
                    <p>Greek Lawn</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/heathers.jpg)"></div>
					<h3>Heathers: The Musical</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 20, 2018</p>
                    <p>Greek Lawn</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/beautiful.png)"></div>
					<h3>Fearless Friday</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 20, 2018</p>
                    <p>Greek Lawn</p>
...
//                endforeach;
    ...
    <div id="3" class="section ninety">
        ...
        <div class="grid">
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/GUTs_Web.png)"></div>
					<h3>Guts!</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 21, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/buddyweb.png)"></div>
					<h3>Build a Buddy!</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 21, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/Sk8ting_Web.png)"></div>
					<h3>Sk8ing!</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 21, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/FoodtrucksWeb.JPG)"></div>
					<h3>Phat! Food Trucks</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 21, 2018</p>
                    <p>Greek Lawn</p>
...
//                endforeach;
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/heel.png)"></div>
					<h3>Heel Violence</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 22, 2018</p>
			...
			<div class="column cols-2">
				<div class="card" >
                    <div class="card-image" style="background-image: url(images/color.JPG)"></div>
					<h3>Color Run</h3>
                    <h4>Sponsored by CAB</h4>
                    <br>
                    <p>April 22, 2018</p>
